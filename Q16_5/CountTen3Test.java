...
public class CountTen3Test {
    ...
    public void mainがスレッドを動かしたか確認() throws InterruptedException {
        ...
        ct3.join();
        //想定したスレッド名にならない
        assertThat(output.toString(), containsString("Thread[Thread-0,5,main]:i9"));
        assertThat(output.toString(), containsString("Thread[Thread-1,5,main]:i9"));
        assertThat(output.toString(), containsString("Thread[Thread-2,5,main]:i9"));
